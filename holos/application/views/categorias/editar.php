                    ...
                    <div class="widget-body form">
                        <form class="form-horizontal" method="post">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="small" name="categoria" value="<?=$cat['categoria']?>" required autofocus>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Honorario</label>
                                <div class="controls">
                                    <input type="text" class="small" name="honorario" value="<?=$cat['honorario']?>" required>
                                </div>
                            </div>
